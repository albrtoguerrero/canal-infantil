...
// Pipeline completo: guion -> voz -> imágenes -> vídeo -> subida (en privado)
async function main() {
  ...
  console.log("3/5 Descargando ilustraciones...");
  const imagenes = await descargarImagenes(guion.titulo, dir);
